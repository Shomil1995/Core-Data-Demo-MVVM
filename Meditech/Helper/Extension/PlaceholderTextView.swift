...
//
//private let kPlaceholderTextViewInsetSide: CGFloat = 12
...
@IBDesignable class PlaceholderTextView: UITextView {
    ...
    @IBInspectable var TextViewBorderWidth: CGFloat = 0.0 {
        didSet {
            self.layer.borderWidth = borderWidthView
        }
    }
    /** Border color for the text view */
    @IBInspectable var TextViewCornerRadius: CGFloat = 6.0 {
        didSet {
            ...
            self.layer.masksToBounds = cornerRadiusView > 0.0
        }
    }
    ...
    func placeholderBoundsContainedIn(_ containerBounds: CGRect) -> CGRect {
        ...
        //let baseRect = UIEdgeInsetsInsetRect(containerBounds, UIEdgeInsetsMake(13, kPlaceholderTextViewInsetSpan, 0, 0))
        
//        let baseRect = UIEdgeInsetsInsetRect(containerBounds, UIEdgeInsets(top: kPlaceholderTextViewInsetSpan+self.contentInset.top, left: kPlaceholderTextViewInsetSpan/2.0+self.contentInset.left, bottom: 0, right: 0))
        
        let baseRect = containerBounds.inset(by: UIEdgeInsets(top: kPlaceholderTextViewInsetSpan+self.contentInset.top, left: kPlaceholderTextViewInsetSpan/2.0+self.contentInset.left, bottom: 0, right: 0))
